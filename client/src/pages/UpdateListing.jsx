        ...
        <div className='p-3 max-w-4xl mx-auto'>
            ...
            <form  onSubmit={handleSubmit}  className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    <input value = {formData.name} onChange={handleChange} type="text" id="name" placeholder='Name' maxLength='62' minLength='10' required className='rounded-lg p-3 border w-full' />
                    <textarea value = {formData.description} onChange={handleChange} type="text" id="description" placeholder='Description' className='rounded-lg border p-3 w-full' required />
                    <input value={formData.address} onChange={handleChange} type="text" id="address" placeholder='Address' className='rounded-lg p-3 w-full' required />
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <button type="submit" disabled={fileLoading || loading} className='bg-slate-700 p-3 uppercase text-center text-white w-full rounded-lg'>{loading ? "LOADING..." : "UPDATE LISTING"}</button>
